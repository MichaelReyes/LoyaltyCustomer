...
/**
 * Entity mapped to table "TRANSACTION_HAS_REWARDS".
 */
public class TransactionHasRewards {

    private Long id;
    private Long reward_id;
    private String sales_transaction_number;

    public TransactionHasRewards() {
    }

    public TransactionHasRewards(Long id) {
        this.id = id;
    }

    public TransactionHasRewards(Long id, Long reward_id, String sales_transaction_number) {
        this.id = id;

...
/** 
 * DAO for table "TRANSACTION_HAS_REWARD".
*/
public class TransactionHasRewardDao extends AbstractDao<TransactionHasReward, Long> {

    public static final String TABLENAME = "TRANSACTION_HAS_REWARD";

    /**
     * Properties of entity TransactionHasReward.<br/>
    ...
    */
    ...
    public TransactionHasRewardDao(DaoConfig config) {
        super(config);
    }
    
    public TransactionHasRewardDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRANSACTION_HAS_REWARD\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRANSACTION_HAS_REWARD\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TransactionHasReward entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TransactionHasReward readEntity(Cursor cursor, int offset) {
        TransactionHasReward entity = new TransactionHasReward( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TransactionHasReward entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TransactionHasReward entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TransactionHasReward entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

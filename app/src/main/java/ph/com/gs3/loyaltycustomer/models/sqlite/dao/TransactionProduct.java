...
public class TransactionProduct {
    ...
    public TransactionProduct(Long id, Integer sales_id, Integer product_id, String product_name, Float unit_cost, String sku, Integer quantity, Float sub_total, String sale_type) {
        this.id = id;

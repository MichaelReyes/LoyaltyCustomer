...
public class TransactionProduct {
    ...
    public TransactionProduct(Long id, String sales_transaction_number, Long product_id, String product_name, Float unit_cost, String sku, Integer quantity, Float sub_total, String sale_type) {
        this.id = id;
